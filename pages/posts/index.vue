...
const postsCategoryList = ref([
  ...
  },
  {
    ...
    name: 'Bootstrap4',
    icon: '',
    posts: [{ id: '00', title: 'Bootstrap4教程 1', likesCount: 19 },
    { id: '01', title: 'Bootstrap教程 2', likesCount: 0 },
    { id: '02', title: 'Bootstrap教程 3', likesCount: 0 },
    { id: '03', title: 'Bootstrap教程 4', likesCount: 0 }
    ]
  },
  {
    id: '3', // Number as ID
...
const selectCategory = (id) => {
  currentPostCategory.value = postsCategoryList.value[id];
}
</script>
...
<template>
  <div class="posts">
    <!-- Welcome Banner -->
    <ForumBanner title="学习区文章" sub-title="知识图谱成就世界">
      ...
      <div class="container">
        ...
        <div class="sidebar">
          <div class="posts-category">
            ...
            <el-menu default-active="0" class="posts-category-menu" @select="selectCategory">
              <el-menu-item v-for="item of postsCategoryList" :index="item.id" :key="item.id"
        ...
        <main class="main-content">
          <div class="content-header">
            <h1 class="content-title">{{ currentPostCategory.name }}系列教程</h1>
          </div>

          <!-- Forum posts -->
          <div class="posts-list">
            <NuxtLink :to="`/posts/${post.id}`" class="post-card" v-for="post in currentPostCategory.posts"
              :key="post.id">
